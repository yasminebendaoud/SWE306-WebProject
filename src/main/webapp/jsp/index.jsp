...
<header class="container my-5 py-3 position-relative">
    <div class="row justify-content-center align-items-center">
        <div class="col-10 col-sm-8 col-md-4 position-relative text-center">
            ...
            <!-- Background Layered Big Script Typography -->
            ...
            <!-- High Fashion Editorial Centered Image -->
            <div class="position-relative" style="z-index: 1; padding: 0 10px;">
                <img src="https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=600" 
                     class="img-fluid border border-dark" alt="Luna e Vino Culinary Presentation">
            </div>
            
        </div>
    </div>
    
    <!-- Fine-line Footer Detail Elements -->
